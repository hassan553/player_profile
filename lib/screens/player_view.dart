...
class PalyersState extends State<PlayerProfileView>
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    playerNameWidget(index),
                    const SizedBox(height: 10),

                    playerAboutWidget(index),
                    Padding(
  ...
  FadeInDown playerAboutWidget(int index) {
    return FadeInDown(
      duration: const Duration(milliseconds: 750),
      delay: const Duration(milliseconds: 100),
      child: Text(
  ...
  FadeInDown playerNameWidget(int index) {
    return FadeInDown(
  ...
  SizedBox backgroundImage(BuildContext context, int index) {
    return SizedBox(
      height: MediaQuery.of(context).size.height,
      width: MediaQuery.of(context).size.width,
